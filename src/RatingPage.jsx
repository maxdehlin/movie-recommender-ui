          ...
          <div className='space-y-12'>
                    ...
                    >
                      ...
                      >
                        <path
                          strokeLinecap='round'
                          strokeLinejoin='round'
                          strokeWidth={savedRecommendations.has(movie) ? 0 : 2}
            ...
            <section className='flex flex-col sm:flex-row items-center justify-center space-y-6 sm:space-y-0 sm:space-x-8 pt-8'>
              <button
                ...
                disabled={isLoading}
                className='px-10 py-4 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white rounded-2xl font-semibold transition-all duration-300 hover:scale-105 disabled:opacity-50 shadow-lg hover:shadow-indigo-500/25 border border-indigo-400/20 tracking-wide bg-no-repeat'
              >
